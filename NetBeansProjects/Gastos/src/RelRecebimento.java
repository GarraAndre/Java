...
public class RelRecebimento extends javax.swing.JFrame {

    
    public RelRecebimento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelRecebimento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelRecebimento().setVisible(true);
            }
        });
    }
